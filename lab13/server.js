...
app.post('/api/comments', function(req, res) {
    var collection = db.collection('steve');
...
app.get('/api/comments/:id', function(req, res) {
    db.collection('steve').find({"id": Number(req.params.id)}).toArray(function(err, docs) {
        if (err) throw err;
        res.json(docs);
    });
});
